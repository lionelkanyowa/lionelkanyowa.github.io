...
title: Resources
permalink: /resources/
description: What I'm learning with — the courses, books, and references behind the software-engineering journey.
---
...
- **[Proxmox VE](https://www.proxmox.com/en/proxmox-virtual-environment)** — the hypervisor the lab runs on.
- **[OPNsense](https://opnsense.org/)** — the open-source firewall guarding the private network.

---

*This list stays deliberately small. If something isn't earning its place in the current work, it comes off.*
