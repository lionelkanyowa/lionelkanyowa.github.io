layout: page title: DevOps Roadmap permalink: /devops-roadmap/
<div class="hero section-small"> <div class="wrapper"> <h1>My DevOps Learning Journey</h1> <p class="hero-subtitle">A structured roadmap documenting my path through DevOps engineering, from fundamentals to advanced practices. This roadmap serves as both a learning guide and a progress tracker.</p> </div> </div> <section class="section-standard"> <div class="wrapper"> <div class="grid-roadmap">
    ...
    <div class="card">
      ...
      <div class="mt-2">
        ...
        <div class="flex-between">
          <span>✅ Completed</span>
          <span class="stat-green">8 sections</span>
        </div>
        <div class="flex-between">
          <span>🔄 In Progress</span>
          <span class="stat-blue">3 sections</span>
        </div>
        <div class="flex-between">
          <span>📅 Planned</span>
          <span class="stat-gray">4 sections</span>
        </div>
      </div>
    </div>
  </div>
...
</div> </section> <section class="section-alt"> <div class="wrapper"> <h2 class="text-center mb-3">Learning Resources</h2>
<div class="card-grid">
  <div class="card">
